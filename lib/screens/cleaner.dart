...
import 'package:project_flutter_ui/screens/detailcleaner.dart';
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () {
                // Aksi ketika item diklik (navigasi ke halaman detail)
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DetailCleanerPage()),
                );
              },
              child: Container(
